...
public class ReadAndWriteFile {
    public static final String PAYMENT_PATH = "src/data/paymentAccount.csv";
    ...
    public static void writeBankAccountToCSV(List<BankAccount> bankAccountList,boolean append){
        ...
        writeListToCSV(strings,PAYMENT_PATH,append);
    }
    ...
    public static List<BankAccount> readBankAccountToCSV(){
        List<String> list = readFileToCSV(PAYMENT_PATH);
